...
import net.sasasin.sreader.commons.dao.ContentViewDao;
import net.sasasin.sreader.commons.dao.PublishLogDao;
import net.sasasin.sreader.commons.dao.impl.ContentViewDaoHibernateImpl;
import net.sasasin.sreader.commons.dao.impl.PublishLogDaoHibernateImpl;
import net.sasasin.sreader.commons.entity.ContentView;
