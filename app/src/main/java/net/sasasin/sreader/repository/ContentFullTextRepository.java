...
public class ContentFullTextRepository {
  ...
  public boolean insertIfAbsent(ContentFullText fullText) {
    ...
    return dsl.insertInto(CONTENT_FULL_TEXT)
            ...
            .set(CONTENT_FULL_TEXT.EXTRACTION_METHOD, (String) null)
            .set(CONTENT_FULL_TEXT.EXTRACTION_STATUS, "success")
            .set(CONTENT_FULL_TEXT.ERROR_MESSAGE, (String) null)
            .set(CONTENT_FULL_TEXT.SOURCE_KIND, (String) null)
            .set(CONTENT_FULL_TEXT.EXTRACTED_URL, (String) null)
