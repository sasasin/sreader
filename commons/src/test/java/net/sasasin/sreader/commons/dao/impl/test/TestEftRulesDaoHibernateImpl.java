 ...
 */
package net.sasasin.sreader.commons.dao.impl.test;
...
import net.sasasin.sreader.commons.testcasesupport.AbstractHibernateTestCase;
...
public class TestEftRulesDaoHibernateImpl extends AbstractHibernateTestCase {
	...
	private EftRulesDao testee = null;
	...
	public void testFindAllNotFound() throws Exception {
		...
		DatabaseOperation.DELETE_ALL.execute(getConnection(),
				new DefaultDataSet(new DefaultTable("eft_rules")));
