...
entity/DAO、JPA、legacy batch shell script は標準 build/runtime path から
外しています。
...
- `commons/`、`batch/`: legacy reference。標準 reactor には含めません
...
旧 `batch/script/run_feedreader.sh` / cron 方式は廃止し、Spring Scheduler が
